                    ...
                    if (res.rows.length > 0) {
                        for (var i = 0; i < res.rows.length; i++) {
                            ...
                            $scope.lists.push({
                                ...
                                category_item_id: resRows.category_item_id,
                                category_item_name: resRows.category_item_name,
                                category_item_price: resRows.category_item_price,
                                category_item_unit: resRows.category_item_unit,
                                category_item_date: resRows.category_item_date
                            });
                        }
                    }
                }, function (err) {
                ...
                if (res.rows.length > 0) {
                    for (var i = 0; i < res.rows.length; i++) {
                        ...
                        $scope.lists.push({
                            ...
                            category_item_id: resRowsLoad.category_item_id,
                            category_item_name: resRowsLoad.category_item_name,
                            category_item_price: resRowsLoad.category_item_price,
                            category_item_unit: resRowsLoad.category_item_unit,
                            category_item_date: resRowsLoad.category_item_date
                        });
